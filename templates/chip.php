...
<span class="csfn-cite" id="csfn-ref-<?php echo esc_attr($csfn_n); ?>">
    ...
    >
        <?php if ($csfn_has_icon) : ?>
            <img class="csfn-chip__favicon" src="<?php echo esc_url($csfn_item['favicon'], ['http', 'https', 'data']); ?>" alt="" loading="lazy" />
        <?php endif; ?>
        <?php if ($csfn_globe) : ?>
